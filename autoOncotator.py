...
class autoOncotator:
    ...
    def __init__(self, filesize, project, input_dir, output_dir, tsv, maf):
    ...
    def oncotator_api(self, filesize, project, output_dir, tsv, maf):
        #filesize, project, download, datapath
        fail = []
...
def work_log(work_data):
    ...
    p1.oncotator_api(p1.filesize, p1.project, p1.output_dir, p1.tsv, p1.maf)
        ...
        with open('project_size.txt', 'r') as f:
            for i in f.readlines():
                if i.split()[-1] in vcfs:
                    work.append([i.split()[4], i.split()[-1]])
